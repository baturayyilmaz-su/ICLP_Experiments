	...
	for root,dirs,files in os.walk(outputDir):
		for outputFile in files:
			...
			with open(os.path.join(outputDir, outputFile), "r") as oFile:
				...
				isSat = int(tokens[1].strip().split("n")[0].strip()) != 0
		

			if not isSat:
				continue
			p1 = int(outputFile.strip().split("-")[2].strip())
			dictIndex = int((100 - p1) / 25)
...
def main():
	...
	dict_20_0, dict_20_25, dict_20_5, dict_20_75 = handleOutputDir(os.path.join("Results", "Experiment 1 Results", "Existing Benchmark", "RES_20"), 20)
	dict_40_0, dict_40_25, dict_40_5, dict_40_75 = handleOutputDir(os.path.join("Results", "Experiment 1 Results", "Existing Benchmark", "RES_40"), 40)
	dict_60_0, dict_60_25, dict_60_5, dict_60_75 = handleOutputDir(os.path.join("Results", "Experiment 1 Results", "Existing Benchmark", "RES_60"), 60)
	dict_80_0, dict_80_25, dict_80_5, dict_80_75 = handleOutputDir(os.path.join("Results", "Experiment 1 Results", "Existing Benchmark", "RES_80"), 80)
	dict_100_0, dict_100_25, dict_100_5, dict_100_75 = handleOutputDir(os.path.join("Results", "Experiment 1 Results", "Existing Benchmark", "RES_100"), 100)
